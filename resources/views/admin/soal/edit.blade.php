  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="/admin/questions/{{$question->id}}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
        <input type="text" class="form-control {{$errors->first('exam_id', 'is-invalid')}}" id="exam_id" name="exam_id" value="{{$question->exam_id}}" hidden>
        <input type="text" class="form-control {{$errors->first('oldImage', 'is-invalid')}}" id="oldImage" name="oldImage" value="{{$question->image}}" hidden>
        <label class="input-group mb-3" for="image">Image</label>
        {!!$question->image? "<img src='". asset('storage/questionsImage/'.$question->exam->category_id.'/'.$question->exam->material_id.'/'.$question->exam->slug.'/'.$question->image)."' class='image-preview img-fluid mb-2 col-sm-5'>": "<img class='image-preview img-fluid mb-2 col-sm-5'>"!!}
        @error('image')   
        ...
        @error('opt_a')   
          ...
          @enderror
        <div class="input-group mb-3">
          <textarea type="text" class="form-control" id="opt_a" name="opt_a">{{old('opt_a', $question->opt_a)}}</textarea>
        </div>
        ...
        @enderror
        <div class="input-group mb-3">
          <textarea type="text" class="form-control" id="opt_b" name="opt_b">{{old('opt_b', $question->opt_b)}}</textarea>
        </div>
        ...
        @enderror
        <div class="input-group mb-3">
          <textarea type="text" class="form-control" id="opt_c" name="opt_c">{{old('opt_c', $question->opt_c)}}</textarea>
        </div>
        ...
        @enderror
        <div class="input-group mb-3">
          <textarea type="text" class="form-control" id="opt_d" name="opt_d">{{old('opt_d', $question->opt_d)}}</textarea>
        </div>
        ...
        @enderror
        <div class="input-group mb-3">
          <textarea type="text" class="form-control" id="opt_e" name="opt_e">{{old('opt_e', $question->opt_e)}}</textarea>
        </div>
        ...
        <div class="input-group mb-3 col-md-8">
          <input type="text" class="form-control {{$errors->first('key', 'is-invalid')}}" id="key" name="key" value="{{old('key', $question->key)}}">
        </div>
        ...
        @enderror
        <div class="input-group mb-3">
          <textarea type="text" class="form-control" id="explaination" name="explaination">{{old('explaination', $question->explanation)}}</textarea>
        </div>
